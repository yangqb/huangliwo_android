...
public class DLSideBar extends View {
    ...
    private void initData(@Nullable AttributeSet attrs) {
        ...
        final int defaultSideTextColor = res.getColor(R.color.sidebar_default_side_text_color);
        final int defaultSideTextSelectColor = res.getColor(R.color.sidebar_default_side_text_select_color);
        final float defaultSideTextSize = res.getDimension(R.dimen.default_side_text_size);
        final Drawable defaultSideBackground = res.getDrawable(R.color.sidebar_default_side_background);
        final int defaultDialogTextColor = res.getColor(R.color.sidebar_default_dialog_text_color);
        final float defaultDialogTextSize = res.getDimension(R.dimen.sidebar_default_dialog_text_size);
        final Drawable defaultDialogTextBackground = res.getDrawable(R.drawable.dialog_text_bg);
        final int defaultDialogTextBackgroundWidth = res.getDimensionPixelSize(R.dimen.sidebar_default_dialog_text_background_width);
        final int defaultDialogTextBackgroundHeight = res.getDimensionPixelSize(R.dimen.sidebar_default_dialog_text_background_height);
        // 读取配置信息
