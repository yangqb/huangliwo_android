...
/**
 */
public class StrategyItemAdapter extends BaseQuickAdapter<ListPageBean.RowsBean, BaseViewHolder> {

    public StrategyItemAdapter(List<ListPageBean.RowsBean> list) {
