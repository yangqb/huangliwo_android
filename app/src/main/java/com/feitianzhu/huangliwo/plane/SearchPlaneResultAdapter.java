...
public class SearchPlaneResultAdapter extends BaseMultiItemQuickAdapter<MultipleGoSearchFightInfo, BaseViewHolder> {
    ...
    protected void convert(@NonNull BaseViewHolder helper, MultipleGoSearchFightInfo item) {
        ...
        if (helper.getItemViewType() == MultipleGoSearchFightInfo.DOMESTIC_TYPE) {
            ...
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(DoubleUtil.mul(item.flightModel.zk, item.flightModel.barePrice))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(DoubleUtil.mul(item.flightModel.zk, item.flightModel.barePrice))));
        } else {
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(DoubleUtil.mul(item.internationalFlightModel.zk, item.internationalFlightModel.price))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(DoubleUtil.mul(item.internationalFlightModel.zk, item.internationalFlightModel.price))));
