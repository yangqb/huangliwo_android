...
public class OptMerchantsAdapter extends BaseQuickAdapter<MerchantsModel, BaseViewHolder> {
    ...
    protected void convert(@NonNull BaseViewHolder helper, MerchantsModel item) {
        ...
        Glide.with(mContext).load(item.getShopFrontImg()).apply(new RequestOptions().placeholder(R.mipmap.g10_04weijiazai).placeholder(R.mipmap.g10_04weijiazai)).into((ImageView) helper.getView(R.id.merchants_img));
