 ...
 */
public class RecommendedAdapter extends BaseQuickAdapter<BaseGoodsListBean, BaseViewHolder> {
    public RecommendedAdapter(@Nullable List<BaseGoodsListBean> data) {
