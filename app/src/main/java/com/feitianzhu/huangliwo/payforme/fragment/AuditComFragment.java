...
public class AuditComFragment extends LazyFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private static final String STATUS_COM = "1";
    ...
    private void getData() {
        ...
        NetworkDao.payForMeRecord(getActivity(), STATUS_COM, mCurPage + "", PAGE_SIZE, new onConnectionFinishLinstener() {
            @Override
