...
public class PromotionBonusAdapter extends BaseQuickAdapter<TotalScoreModel.RebateRecordsBean.RebateItemBean, BaseViewHolder> {
  public PromotionBonusAdapter(@Nullable List<TotalScoreModel.RebateRecordsBean.RebateItemBean> data) {
    super(R.layout.promotion_bonus_item, data);
  }
