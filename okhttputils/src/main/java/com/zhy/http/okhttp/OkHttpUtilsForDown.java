...
public class OkHttpUtilsForDown {
  public static final long DEFAULT_MILLISECONDS = 10_000L;
  private volatile static OkHttpUtilsForDown mInstance;
  private static boolean mIsdown=false;
  private OkHttpClient mOkHttpClient;
  private Platform mPlatform;

  public OkHttpUtilsForDown(OkHttpClient okHttpClient) {
  ...
  public static OkHttpUtilsForDown initClient(OkHttpClient okHttpClient) {
    if (mInstance == null) {
      synchronized (OkHttpUtilsForDown.class) {
        if (mInstance == null) {
          mInstance = new OkHttpUtilsForDown(okHttpClient);
        }
      }
    }
    return mInstance;
  ...
  public static OkHttpUtilsForDown getInstance() {
